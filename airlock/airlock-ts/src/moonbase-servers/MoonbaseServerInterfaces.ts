import { IIdReferenceFactory, IdReferenceFactory, MoonbaseId } from "d3-artifacts";
...
interface IMoonbaseServers {
    ...
    createServer({id, url}: {id?: MoonbaseId | string, url: MoonbaseServerUrl}): IMoonbaseServer;
