...
import { IdReference, IdReferenceFactory, IdReferenceTypes, PodBayId, PodId } from "d3-artifacts";
...
class LunarPod {
    ...
    public db: Map<string, OpenDbProcess> = new Map<string, OpenDbProcess>();
