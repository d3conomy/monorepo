 ...
 *         value: {topics: ["test"]}
 * */
router.get('/pubsub/topics', async function(req: Request, res: Response) {
 ...
 * */
router.post('/pubsub/subscribe', async function(req: Request, res: Response) {
    const podBay = req.podBay;
 ...
 * */
router.post('/pubsub/publish', async function(req: Request, res: Response) {
    const podBay = req.podBay;
    const topic = req.body.topic;
