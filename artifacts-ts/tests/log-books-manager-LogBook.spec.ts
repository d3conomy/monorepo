...
describe('src/log-books-manager/LogBook.js', () => {
    ...
    it('should add an entry to the log book', () => {
        const entry: LogEntry = new LogEntry({ message: 'Test message', level:  LogLevel.INFO, printLevel: LogLevel.INFO});
        logBook.add(entry);
    ...
    it('should get all entries from the log book', () => {
        const entry1: LogEntry = new LogEntry({ message: 'Test message 1', level: LogLevel.INFO, printLevel: LogLevel.INFO});
        const entry2: LogEntry = new LogEntry({ message: 'Test message 2', level: LogLevel.INFO, printLevel: LogLevel.INFO });
        logBook.add(entry1);
        logBook.add(entry2);
    ...
    it('should get the last n entries from the log book', () => {
        const entry1: LogEntry = new LogEntry({ message: 'Test message 1', level: LogLevel.INFO, printLevel: LogLevel.INFO});
        const entry2: LogEntry = new LogEntry({ message: 'Test message 2', level: LogLevel.INFO, printLevel: LogLevel.INFO });
        const entry3: LogEntry = new LogEntry({ message: 'Test message 3', level: LogLevel.INFO, printLevel: LogLevel.INFO });
        logBook.add(entry1);
        logBook.add(entry2);
        logBook.add(entry3);
