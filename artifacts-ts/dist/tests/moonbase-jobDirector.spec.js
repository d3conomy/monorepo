...
describe('JobDirector', () => {
    ...
    beforeEach(async function () {
        ...
        // Create a completely new pod instance with initialize=false to avoid double init
        pod = await moonbase.createPod({
            ...
            initialize: false // Don't initialize during creation to avoid double init
        });
        // Initialize the pod with its stack (this should only happen once)
        await pod.init();
