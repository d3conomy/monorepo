...
describe('libp2pBootstrap', () => {
    it('should return default bootstrap configuration when no options are provided', () => {
        const result = libp2pBootstrap([{ name: "list", value: true }]);
    ...
    it('should return custom bootstrap configuration when multiaddrs option is provided', () => {
        ...
        const result = libp2pBootstrap([{ name: "defaultConfig", value: false }, { name: "multiaddrs", value: multiaddrs }, { name: "list", value: true }]);
        expect(result.toString()).to.equal([
            "/dnsaddr/bootstrap.libp2p.io/p2p/QmNnooDu7bfjPFoTZYxMNLWUQJyrVwtbZg5gBMjTezGAJN",
            "/dnsaddr/bootstrap.libp2p.io/p2p/QmQCU2EcMqAqQPR2i9bChDtGNJchTbq5TbXJJ16u19uLTa",
            "/dnsaddr/bootstrap.libp2p.io/p2p/QmbLHAnMoJPWSCR5Zhtx6BHJX9KiKNN6tpvbUcqanj75Nb",
    ...
    it('should return a function when options are provided', () => {
        const result = libp2pBootstrap([{ name: "defaultConfig", value: false }, { name: "list", value: false }]);
        expect(result).to.be.a('function');
    });
});
