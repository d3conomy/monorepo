...
import { IProcessCommand, IProcessExecuteCommand, ProcessCommands, ProcessType, createProcessCommand, createProcessCommandArgs, createProcessContainer, runCommand } from "../src/process-interface/index.js";
...
describe('ProcessCommands', () => {
    ...
    beforeEach( async () => {
        ...
        commands = new ProcessCommands({commands: libp2pCommands, container: createProcessContainer({type: ProcessType.LIBP2P, instance: process})})
    });
