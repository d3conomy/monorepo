...
interface CommandTemplate
    extends Template<TemplateTypes.COMMANDS, TemplateVersions.V1> 
{    
    spec: {
        args?: CommandArg<any>[];
        run: string;
...
interface JobTemplate
    extends Template<TemplateTypes.JOB, TemplateVersions.V1>
{
    spec: {
        command: string;
...
interface ContainerTemplate<T = InstanceType>
    extends Template<TemplateTypes.CONTAINER, TemplateVersions.V1>
{
    spec: {
        instanceType: T;
...
interface PodTemplate
    extends Template<TemplateTypes.LUNAR_POD, TemplateVersions.V1>
{
    spec: {
...
interface PodBayTemplate
    extends Template<TemplateTypes.POD_BAY, TemplateVersions.V1>
{
    spec: {
        pods: PodTemplate[];
        options: InstanceOption<any>[];
...
interface SystemTemplate
    extends Template<TemplateTypes.SYSTEM, TemplateVersions.V1>
{
    spec: {
